...
const ApprovedReviewsPage = () => {
  const reviews = [
    ...
    {
      id: 2,
      design: "Electrical Schematic v1.0",
    ...
    {
      id: 4,
      design: "Component Assembly v1.0",
      approvedBy: "Sarah Lee",
    ...
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        {reviews.map((review) => (
          <div
            key={review.id}
            className="bg-white dark:bg-slate-800 rounded-lg border border-green-200 dark:border-green-800 p-6"
          >
            <div className="flex items-start justify-between mb-4">
              <div>
                ...
                <p className="text-sm text-slate-600 dark:text-slate-400">
                  Approved by:{" "}
                  <span className="font-medium">{review.approvedBy}</span>
                </p>
              </div>
