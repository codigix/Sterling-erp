...
const ResourceAllocationPage = () => {
  ...
  const filturedResources = resources.filter(
    (resource) =>
  ...
  const stats = [
    ...
    {
      label: "Total Workers",
      value: resources.reduce((sum, r) => sum + r.totalWorkers, 0),
      color: "text-green-600",
    },
    {
      label: "Allocated",
      value: resources.reduce((sum, r) => sum + r.allocated, 0),
      color: "text-yellow-600",
    },
    {
      label: "Available",
      value: resources.reduce((sum, r) => sum + r.available, 0),
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-slate-500 dark:text-slate-400 mt-1">
            Manage workforce allocation across departments
          </p>
        </div>
              ...
              >
                <div className="flex items-center text-xs justify-between mb-4">
                  <div>
                    ...
                    <p className="text-sm text-slate-600 dark:text-slate-400">
                      {resource.activeProjects} active project(s)
                    </p>
                  </div>
                    ...
                    <div className="flex items-center text-xs gap-2">
                      <div className="flex-1 h-2 bg-slate-200 dark:bg-slate-700 rounded-full overflow-hidden">
                        <div
                          ...
                          style={{
                            width: `${
                              (resource.allocated / resource.totalWorkers) * 100
                            }%`,
                          }}
                        ></div>
                      </div>
            ...
            <div className="border-t border-slate-200 dark:border-slate-700 pt-4">
              ...
              <div className="space-y-2">
                {resources.map((resource) => (
                  <div
                    key={resource.id}
                    className="flex items-center text-xs justify-between text-sm"
                  >
