    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-slate-500 dark:text-slate-400 mt-1">
            Comprehensive production and quality metrics dashboard
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-white dark:bg-slate-800 rounded-lg border border-slate-200 dark:border-slate-700 p-6">
          <h2 className="text-xl font-bold text-slate-900 dark:text-white text-xs text-left mb-6 flex items-center text-xs gap-2">
            <BarChart3 size={24} />
            Stage Performance
          </h2>
                  ...
                  <div>
                    ...
                    <div className="w-full bg-slate-200 dark:bg-slate-700 rounded-full h-2">
                      <div
                        ...
                        style={{
                          width: `${(trend.actual / trend.planned) * 100}%`,
                        }}
                      ></div>
                    </div>
                  </div>
        ...
        <div className="space-y-3">
          <div className="p-4 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-700 rounded-lg">
            <p className="text-sm text-green-700 dark:text-green-300">
              <strong>Positive:</strong> On-time delivery rate improved by 3%
              this month. Maintain current scheduling practices.
            </p>
          </div>
          <div className="p-4 bg-orange-50 dark:bg-orange-900/20 border border-orange-200 dark:border-orange-700 rounded-lg">
            <p className="text-sm text-orange-700 dark:text-orange-300">
              <strong>Alert:</strong> Welding & Assembly stage efficiency
              dropped to 89%. Review resource allocation.
            </p>
          </div>
          <div className="p-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-700 rounded-lg">
            <p className="text-sm text-blue-700 dark:text-blue-300">
              <strong>Recommendation:</strong> Increase quality inspections in
              Finishing stage to maintain 95%+ quality scores.
            </p>
          </div>
        </div>
      </div>
