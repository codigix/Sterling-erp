...
// Design routes
router.get('/designs', roleMiddleware('Admin', 'Management', 'Production', 'Design Engineer'), productionController.getDesigns);
router.get('/designs/:id', roleMiddleware('Admin', 'Management', 'Production', 'Design Engineer'), productionController.getDesignById);
router.get('/designs/:id/download', roleMiddleware('Admin', 'Management', 'Production', 'Design Engineer'), productionController.downloadDesignDocument);
router.post('/design-projects', roleMiddleware('Admin', 'Management', 'Design Engineer'), upload.array('documents'), productionController.createDesignProject);
router.patch('/designs/:id/status', roleMiddleware('Admin', 'Management', 'Design Engineer'), productionController.updateDesignStatus);
router.delete('/designs/:id', roleMiddleware('Admin', 'Management', 'Design Engineer'), productionController.deleteDesignProject);
