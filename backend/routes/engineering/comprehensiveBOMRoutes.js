...
router.post('/', 
  roleMiddleware('Admin', 'Management', 'Design Engineer', 'design_engineer', 'Engineering', 'engineering'),
  comprehensiveBOMController.createComprehensiveBOM
);

router.get('/',
  roleMiddleware('Admin', 'Management', 'Design Engineer', 'design_engineer', 'Engineering', 'engineering', 'Production', 'production', 'production_manager'),
