...
router.get('/:id', roleMiddleware('Admin', 'Inventory', 'Inventory Manager', 'inventory_manager', 'Production', 'production', 'production_manager'), warehouseController.getWarehouseById);
router.get('/', roleMiddleware('Admin', 'Inventory', 'Inventory Manager', 'inventory_manager', 'Production', 'production', 'production_manager'), warehouseController.getAllWarehouses);
